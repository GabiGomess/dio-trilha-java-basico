...
public class ProcessoSeletivo{
    ...
    static void entrandoEmContato(String candidato) {
        ...
        if(atendeu) System.out.println("CONSEGUIMOS CONTATO COM " + candidato + " NA " + tentativasRealizadas + "ª TENTATIVA");
    ...
    static void imprimirSelecionados() {
        ...
        for(int i = 0; i < candidatos.length; i++) {
            System.out.println("Candidato de n " + (i+1) + " é " + candidatos[i]);
        }
